				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-car color-blue"></em>
							...
							<div class="text-muted">Kendaraan yang Terparkir</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-toggle-on color-orange"></em>
							...
							<div class="text-muted">Kendaraan Masuk</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-toggle-off color-teal"></em>
							...
							<div class="text-muted">Kendaraan Keluar</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-red panel-widget ">
						<div class="row no-padding"><em class="fa fa-xl fa-clock-o color-red"></em>
							...
							<div class="text-muted">Kendaraan yang terparkir Lebih dari 24 Jam</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">
						Kendaraan yang tersorot - Masuk | Keluar 
...
<!---->
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">
					Kendaraan yang tersorot - Jenis Kendaraan
	...
	<!---->	
		...
		$ret=mysqli_query($con,"SELECT count(ID) as id1 from vehicle_info where VehicleCategory='Roda 2'");
		 $row=mysqli_fetch_array($ret);  
             
		$ret=mysqli_query($con,"SELECT count(ID) as id2 from vehicle_info where VehicleCategory='Roda 4'");
		 $row2=mysqli_fetch_array($ret); 

		$ret=mysqli_query($con,"SELECT count(ID) as id4 from vehicle_info where VehicleCategory='Roda 3'");
	...
	type: 'pie',
	data: {
	labels: ["Dua Roda","Empat Roda", "Tiga Roda"],
	datasets: [{
	backgroundColor: ["#F6416C","#FFDE7D","#6B6B6B"],
