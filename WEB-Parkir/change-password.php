...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
					<div class="panel-heading"> Password diganti</div>
					<div class="panel-body">
						...
						$msg</div>" ?> 
							<form method="POST">
                                ...
                                ?>
								<label>Password yang masih ada</label>
                                ...
                                <div class="col-lg-6">
								<div class="form-group">
									<label>Password terkonfirmasi</label>
									<input type="password" class="form-control" name="confirmpassword" required>
								</div>
                                </div>
<center><button type="submit" class="btn btn-info" name="change-password">ganti password</button></center>		
								</div>
                                <?php } ?>
							</form>
						</div> 
