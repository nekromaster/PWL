	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Atur Jenis Kendaraan</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Jenis Kendaraan<a href="add-category.php" type="button" class="btn btn-sm btn-primary">Add New Vehicle Category</a></div>
