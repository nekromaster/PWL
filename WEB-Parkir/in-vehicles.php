	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Manajemen kendaraan yang datang</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">	
        ...
        ?>
            ...
            <td><a href="update-incomingdetail.php?updateid=<?php echo $row['ID'];?>"><button type="button" class="btn btn-sm btn-danger">Ambil Tindakan</button></a>
            </td>
            </tr>
                <?php $cnt=$cnt+1;}?>
        </tbody>
